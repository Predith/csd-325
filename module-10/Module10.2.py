...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.title("Kuenning To-Do App")
        self.geometry("300x400")

        menubar = tk.Menu(self)
        file_menu = tk.Menu(menubar, tearoff=0)
        file_menu.add_command(label="Exit", command=self.quit)  # Exit command
        ...
        todo1 = tk.Label(self.tasks_frame, text="Add Items Here --- **Right Click Item to Delete**", bg="Yellow",
            fg="Black", pady=10)
        ...
        self.colour_schemes = [{"bg": "Yellow", "fg": "Black"}, {"bg": "LightBlue", "fg":
            "Black"}]
